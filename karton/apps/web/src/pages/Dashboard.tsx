...
export function Dashboard(): React.JSX.Element {
  ...
  return (
    // Sekcije su „grid-area" jedinice. Na telefonu su .dash-sec (display:contents)
    // providne, pa se sve slaže istim redosledom kao pre (mobilni se NE menja).
    // Na ≥1024 grid ih rasporedi: gore levo Posao, gore desno Danas, a Vozila i
    // Novac preko cele širine ispod.
    <div className="page dash">
      <div className="dash-sec dash-a-head">
      ...
      <div className="dash-sec dash-a-quick">
        <div className="quick">
      ...
      <div className="dash-sec dash-a-posao">
      ...
      <div className="dash-sec dash-a-vozila">
      ...
      <div className="dash-sec dash-a-novac">
      ...
      <div className="dash-sec dash-a-danas">
