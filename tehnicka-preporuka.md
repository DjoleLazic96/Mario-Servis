...
- **Status (10.7.2026): URAĐENO i testirano na živoj kartici.** Java helper (`citac-saobracajne/src/CitacServer.java`) čita srpsku saobraćajnu preko `javax.smartcardio`, sluša na `127.0.0.1:8765` sa Origin allowlist-om, vraća JSON (VIN, marka, model, gorivo, godina, tablica, vlasnik). Dugme „Učitaj saobraćajnu" u formi vozila ga poziva i puni formu. Verifikovano na Škoda Kodiaq kartici. Preostaje samo pakovanje u Windows instaler (`jpackage`) pri isporuci.
